;(function ($, window) {
    let ele = null,
        ...
        g = {},//全局变量
        defaults = {
            "navWidth": 78,//列表每个宽度,该版本中请把宽高填写成一样
            "navHeight": 78,//列表每个高度,该版本中请把宽高填写成一样
            "navItemNum": 5,//列表显示个数
    ...
    let methods = {
        init: function (options) {
            ...
            // 数据生成照片
            exzoom_img_ul.addClass('exzoom_img_ul');
            var imgUrl = cookImg.map(function(item){
                return `<li><img src="../../../${item}" /></li>`
            });
            exzoom_img_ul.html(imgUrl);
